...
RSpec.describe 'TopLevelMenu tab' do
  ...
  context 'TPLM bar check' do
	...
	it 'verify that after clicking on the any button on the TPLM bar home icon is displayed'
		current_url = browser.current_url
		tplevelmenu_tab.tshirts.click
		tplevelmenu_tab.wait_for{ current_url != browser.current_url }
	...
	it 'verify that after clicking on the dresses button on the TPLM bar dresses label is displayed'
		current_url = browser.current_url
		tplevelmenu_tab.dresses.click
		tplevelmenu_tab.wait_for{ current_url != browser.current_url }
	...
	it 'verify that after clicking on the women button on the TPLM bar women label is displayed'
		current_url = browser.current_url
		tplevelmenu_tab.women.click
		tplevelmenu_tab.wait_for{ current_url != browser.current_url }
	...
	it 'verify that after clicking on the t-shirts button on the TPLM bar t-shirts label is displayed'
		current_url = browser.current_url
		tplevelmenu_tab.tshirts.click
		tplevelmenu_tab.wait_for{ current_url != browser.current_url }
	...
	it 'verify that after clicking on the home icon current widget will be removed'
		current_url = browser.current_url
		tplevelmenu_tab.women.click
		tplevelmenu_tab.wait_for{ current_url != browser.current_url }
	...
	it 'verify that after clicking on the home icon user will be redirected to the main page'
		current_url = browser.current_url
		tplevelmenu_tab.women.click
		tplevelmenu_tab.wait_for{ current_url != browser.current_url }
		tplevelmenu_tab.home_icon.click
		expect(tplevelmenu_tab.url_include?('http://automationpractice.com/index.php'))
	end
